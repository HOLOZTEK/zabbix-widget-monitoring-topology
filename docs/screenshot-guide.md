...
| `screenshots/monitoring-topology-esxi.png` | Detailed VMware ESXi branch | 1600 x 980 |
...
The README files use the dashboard example as the main preview, four topology images as a two-column comparison, the filter image at narrow-panel width, and the locale-specific settings image. Recheck all images against the sanitizing checklist whenever they are replaced.
